SERVICE_NAME="chirpstack-network-server"
...
image: build
        docker build -t registry.cn-shenzhen.aliyuncs.com/risinghf/chirpstack-network-server:$(IMAGE_VERSION) -f Dockerfile-rxhf .
